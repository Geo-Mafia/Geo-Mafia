...
QUnit.test("Bubble-Player Tests", function(assert) {
    ...
    assert.equal(testbub.List.size, 0, "player list should be empty");
    assert.equal(testbub.returnPlayers, {}, "player list should be empty");
    ...
    assert.equal(testbub.List[0].getUserID, 12, "player added should be identified by id 12");
    assert.equal(testbub.returnPlayers[0].getUserID, 12, "player added should be identified by id 12");
    ...
    assert.equal(testbub.List[1].getUserID, 13, "player added should be identified by id 13");
    assert.equal(testbub.returnPlayers[1].getUserID, 13, "player added should be identified by id 13");    
    ...
    assert.equal(testbub.returnPlayers[0].getUserID, 13, "player in list should be identified by id 13");
